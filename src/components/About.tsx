    ...
    <section id="about" ref={sectionRef} className="py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10 z-0 pointer-events-none">
        <div 
          ...
          style={{ 
            backgroundImage: `url('/lovable-uploads/67682070-b5d2-496a-aaa0-a18e771c5fec.png')`
          }}
        ></div>
      </div>
      ...
      <div className={cn(
        ...
        theme === 'dark' ? 'bg-gradient-to-t from-background via-transparent to-transparent opacity-90' : 'bg-gradient-to-b from-background via-transparent to-transparent opacity-70'
      )}></div>
      
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <p className={cn(
            "inline-block rounded-full px-4 py-1 mb-6 font-medium animate-on-scroll",
            theme === 'dark' ? 'text-primary border border-primary/20' : 'text-accent border border-accent/20'
          )}>
            About Me
          </p>
          <AnimatedText 
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <AnimatedCard className={cn(
            "h-full rounded-2xl overflow-hidden animate-on-scroll",
            theme === 'dark' ? 'border border-primary/10' : 'border border-accent/10'
          )}>
            ...
            <div className="animate-on-scroll" style={{ transitionDelay: '0.3s' }}>
              <div className="flex items-center gap-x-2 mb-3">
                <div className={cn(
                  ...
                  theme === 'dark' ? 'bg-primary/10 text-primary' : 'bg-accent/10 text-accent'
                )}>
